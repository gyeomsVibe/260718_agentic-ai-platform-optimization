...
Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 사용자가 지정한 기본자세 전신 마스터와 완전히 동기화된 커스텀 펫. Preserve silhouette, face, palette, material, proportions, markings, and props.
