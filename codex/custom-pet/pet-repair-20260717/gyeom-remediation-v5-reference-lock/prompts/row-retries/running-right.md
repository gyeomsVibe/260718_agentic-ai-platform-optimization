...
Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 원본 점토 캐릭터 헤어·얼굴·의상·비율을 고정한 커스텀 펫. Preserve silhouette, face, palette, material, proportions, markings, and props.
