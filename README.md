...
| [skills/](skills/) | **Skills 섹션** — 세 도구 공용 "기술 카드" 관리 (발동법·설치법·보안 수칙 학습가이드 포함) | 스킬을 찾고·설치하고·발동법을 배울 때 |
| [shared/](shared/) | **3플랫폼 공용 정본** — 전역 규칙, MIA 플러그인, 직접 만든 스킬, 자동업데이트 | 세 도구가 함께 쓰는 규칙·자동화를 손볼 때 |
