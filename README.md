...
## 지금 설치된 상태 (2026-08-07 실측)

**세 도구 CLI로 실제 발동을 확인한 수치입니다.** 파일 복사 여부가 아닙니다.
2026-08-05에 실패했던 런타임 검증을 재시도해 전부 통과했습니다.

| 도구 | 스킬 | 서브에이전트 | 확인 방법 |
|---|---|---|---|
| Claude Code | **12개** | **4개** | `claude -p` 지목 확인 |
| Codex | **16개** (+ 계정 커넥터) | — | `codex exec` 지목 확인 |
| Antigravity | **15개** | — | `agy --print` 지목 확인 |
