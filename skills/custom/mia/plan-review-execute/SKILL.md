...
description: Activate only when the user explicitly says "MIA모드 발동" to start the 기획·검토·실행 모드 for an evidence-backed product, business, or meaningful technical decision. Do not activate for similar natural-language requests, ordinary coding, writing, or PC maintenance.
---
