...
- **Skill을 쓰는 방법(발동 문구 포함)은 [`docs/02_MANUAL.md`](docs/02_MANUAL.md)가 정본입니다.**
...
```text
skills/
├─ docs/02_MANUAL.md                    # 사용 매뉴얼 — 도구별 발동 트리거
├─ docs/01_DEPLOYMENT.md                # 배포 정본 — 무엇을 어디에 왜 올렸나
├─ custom/
│  ├─ mia/                      # 윤겸스 제작 MIA 시리즈
...
- [Skill 사용 매뉴얼 — 도구별 발동 트리거](docs/02_MANUAL.md)
- [도구별 배포 정본과 선별 근거](docs/01_DEPLOYMENT.md)
